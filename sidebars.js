...
const sidebars = {
  tutorialSidebar: [
    ...
    {
      type: "category",
      label: "Plans, Points & Limits",
      link: {
        type: "generated-index",
        title: "Plans, Points & Limits",
        description:
    ...
    {
      type: "category",
      label: "Migrating to Bitquery",
      link: {
        type: "generated-index",
        title: "Migrating to Bitquery",
        description:
          "Move to Bitquery from Moralis, Alchemy, Helius, Yellowstone gRPC, or GoldSky subgraphs.",
      },
      items: [
        "migration/from-moralis",
        "migration/from-alchemy",
        "migration/from-helius",
        "migration/from-yellowstone",
        "migration/from-goldsky",
      ],
    },
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              type: "doc",
              id: "schema/evm/balances",
              label: "Balances",
            },
            {
              type: "doc",
              id: "schema/evm/token-holders",
              label: "Token Holders",
            },
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            "streams/real-time-indexer-with-kafka-stream",
      ...
      items: [
        "blockchain/supported-chains",
        {
          ...
          items: [
            ...
            "blockchain/Ethereum/transfers/total-supply",
            {
              ...
              items: [
                "blockchain/Ethereum/transfers/erc20-token-transfer-api",
                "blockchain/Ethereum/transfers/ico-token-ownership-transfer",
                "blockchain/Ethereum/transfers/nft-token-transfer-api",
              ],
            },
            {
              type: "category",
            ...
            "blockchain/Ethereum/calls/contract-creation",
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  label: "Trading Pairs",
                  items: [
                    "blockchain/Ethereum/dextrades/get-trading-pairs-of-token",
                    "blockchain/Ethereum/dextrades/latest-trading-pairs-api",
                ...
                },
                {
                  ...
                  items: [
                    "blockchain/Ethereum/dextrades/ethereum-liquidity-api",
                    "blockchain/Ethereum/dextrades/uniswap-v4-liquidity-api",
...

        {
          ...
          items: [
            ...
            "blockchain/BSC/bsc-token-marketcap-api",
            "blockchain/BSC/bsc-slippage-api",
            "blockchain/BSC/bsc-liquidity-api",
            "blockchain/BSC/bsc-uniswap-api",
            "blockchain/BSC/uniswap-v4-api",
            ...
            "blockchain/BSC/bsc-pancakeswap-infinity-api",
        ...
        },
        {
          ...
          items: [
            ...
            "blockchain/Solana/stonkfun-api",
            ...
            "blockchain/Solana/solana-instruction-balance-updates",
            "blockchain/Solana/solana-token-holders",
            "blockchain/Solana/solana-dextrades",
            "blockchain/Solana/solana-token-marketcap-api",
            ...
            "blockchain/Solana/solana-blocks-api",
            "blockchain/Solana/solana-fee-anatomy",
        ...
        },
        {
          ...
          items: [
            ...
            "blockchain/Base/pancakeswap-infinity-api",
        ...
        },
        {
          ...
          items: [
            ...
            "blockchain/Matic/uniswap-v4-api",
        ...
        },
        {
          ...
          items: [
            ...
            "blockchain/robinhood/lighter-perp-dex-api",
            "blockchain/robinhood/robinhood-meme-coin-launches",
            "blockchain/robinhood/pools-trade-api",
            "blockchain/robinhood/pons-api",
            "blockchain/robinhood/flap-sh-api",
            "blockchain/robinhood/trench-today-api",
            "blockchain/robinhood/bags-fm-api",
            "blockchain/robinhood/ondo-stocks-api",
        ...
        },
        {
          ...
          items: [
            ...
            "blockchain/arc-mainnet/arc-argus-launchpad-api",
      ...
      items: [
        "trading/trading-data-overview",
        {
          ...
          items: [
            ...
            "trading/crypto-price-api/supply-fields",
        ...
        },
        {
          ...
          items: [
            ...
            "trading/crypto-trades-api/wallet-pnl",
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          items: [
            ...
            "perpetuals/hyperliquid/hyperliquid-order-flow-by-wallet",
            "perpetuals/hyperliquid/hyperliquid-funding-payments-api",
            "perpetuals/hyperliquid/hyperliquid-twap-fills",
            "perpetuals/hyperliquid/hyperliquid-liquidation-history-by-wallet",
            "perpetuals/hyperliquid/track-zec-on-hyperliquid",
            "perpetuals/hyperliquid/vs-hyperliquid-api",
          ],
        },
          ...
          items: [
            ...
            // },
            {
              ...
              items: [
                ...
                "usecases/tradingview-subscription-realtime/bar-continuity",
              ],
            },
