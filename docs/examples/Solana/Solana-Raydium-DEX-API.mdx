...
You can run this query using [this link](https://ide.bitquery.io/live-price-of-token-on-raydium).
...
subscription {
  Solana {
    DEXTradeByTokens(
      ...
      where: {Trade: {Dex: {ProgramAddress: {is: "675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8"}}, Currency: {MintAddress: {is: "So11111111111111111111111111111111111111112"}}, Side: {Currency: {MintAddress: {is: "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"}}}}}
    ) {
      Block {
        Time
      }
...
If you want to get OHLC data for any specific currency pair on Raydium DEX, you can use [this api](hhttps://ide.bitquery.io/Raydium-OHLC-for-specific-pair_4).
