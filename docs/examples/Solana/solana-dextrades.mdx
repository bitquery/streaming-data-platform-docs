...
[This](https://ide.bitquery.io/Trending-tokens-on--Solana_6) query returns the top 10 trending tokens on Solana across all DEXs based on the number of trades with unique traders.
