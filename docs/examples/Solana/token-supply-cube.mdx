...
- **[Solana Balance Updates API](solana-balance-updates.mdx)** - Monitor balance changes from supply updates
- **[Solana Transfers API](solana-transfers.mdx)** - Track transfers that affect token supply
- **[Solana DEX Trades API](solana-dextrades.mdx)** - Monitor trading activities impacting supply
- **[Solana Fees API](solana_fees_api.md)** - Analyze fees from supply-related transactions
...
For tracking the instructions that cause these supply changes (like token creation and burning), see our **[Solana Instructions API](solana-instructions.mdx)**.
