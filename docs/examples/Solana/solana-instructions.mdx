...
Program Method includes `burn`, indicating that we filter instructions only related to token burning. You can run it [here](https://ide.bitquery.io/solana-token-burn_1)
