...
- **[Solana Balance Updates API](solana-balance-updates.mdx)** - Monitor real-time balance changes
- **[Solana Token Supply API](token-supply-cube.mdx)** - Track token supply and creation events
- **[Solana DEX Trades API](solana-dextrades.mdx)** - Monitor trading activities across DEXs
- **[Solana Transfers API](solana-transfers.mdx)** - Track token transfers and movements
- **[Solana Fees API](solana_fees_api.md)** - Analyze transaction fees and costs
...
For monitoring the balance changes that result from these instructions, see our **[Solana Balance Updates API](solana-balance-updates.mdx)**.
...
For more comprehensive token supply tracking, see our **[Solana Token Supply API](token-supply-cube.mdx)** documentation.
