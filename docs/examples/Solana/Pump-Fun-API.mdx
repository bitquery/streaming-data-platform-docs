...
The below query will get you token metadata. You can use the below query if currency{name, symbol, uri} data fields from query builder gives you empty result for pump fun token metadata.
...
You can run the query [here](https://ide.bitquery.io/Pump-fun-token-metadata_1)
