...
In this document, we will explore several examples related to Pump Fun token data.
...
### Real-time New Token Launch Tracking
...
Live tokens within the specific market cap range highlighted by Pump Fun
[Run Query ➤](https://ide.bitquery.io/track-King-of-the-hill-tokens)
