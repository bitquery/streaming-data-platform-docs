...
These APIs are also available through [Kafka streams](https://docs.bitquery.io/docs/streams/kafka-streaming-concepts/) for zero latency. Contact us on our Telegram Channel.
