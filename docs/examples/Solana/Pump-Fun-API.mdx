...
Use the below query to get Top 10 pump fun tokens by Price change in last 5mins. Test the query [here](https://ide.bitquery.io/Top-10-pump-fun-tokens-by-Price-change-in-last-5mins_2).
