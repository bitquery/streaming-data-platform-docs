...
- **[Solana Balance Updates API](solana-balance-updates.mdx)** - Monitor balance changes from transfers
- **[Solana Instructions API](solana-instructions.mdx)** - Track transfer instructions and events
- **[Solana DEX Trades API](solana-dextrades.mdx)** - Monitor trading transfers and swaps
- **[Solana Fees API](solana_fees_api.md)** - Analyze transfer fees and transaction costs
- **[Solana Token Supply API](token-supply-cube.mdx)** - Track supply changes from transfers
...
For monitoring the balance changes that result from these transfers, see our **[Solana Balance Updates API](solana-balance-updates.mdx)**.
