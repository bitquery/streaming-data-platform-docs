...
You can run the query [here](https://ide.bitquery.io/ATH-using-quantile-on-Solana)

```
{
  Solana(dataset: archive) {
    DEXTradeByTokens(
      where: {Trade: {Currency: {MintAddress: {is: "CboMcTUYUcy9E6B3yGdFn6aEsGUnYV6yWeoeukw6pump"}}, PriceAsymmetry: {lt: 0.01}, AmountInUSD: {gt: "10"}}}
      limit: {count: 1}
