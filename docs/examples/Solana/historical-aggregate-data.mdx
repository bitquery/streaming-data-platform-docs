...
[This](https://ide.bitquery.io/historical-ohlc-for-solana_1) query returns the historical OHLC data for a given pair along with volume
...
## Video Tutorial to Get Historical OHLC Data for Solana 

<VideoPlayer url="https://youtu.be/8Pk6zzN4CrY" />