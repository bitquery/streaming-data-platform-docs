...
TLDR (or not able to understand) then just apply this formulae `bondingCurveProgress= 100 - (((balance - 206900000)*100)/793100000)`. You can get the balance using this below query. You can run and test the saved query [here](https://ide.bitquery.io/Get-balance-of-a-pair-address-on-solana).
