...
[This query](https://ide.bitquery.io/USDT-Solana-Top-100-holders) returns the top 100 token holders of a particular token after a
given time.
...
query {
  Solana {
    BalanceUpdates(
      ...
      limit: {count: 100}
      where: {
        BalanceUpdate: {Currency: {MintAddress: {is: "Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB"}}}
