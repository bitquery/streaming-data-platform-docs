...
- **[Solana Transfers API](https://docs.bitquery.io/docs/examples/Solana/solana-transfers/)** - Track transfers that cause balance changes
- **[Solana Instructions API](https://docs.bitquery.io/docs/examples/Solana/solana-instructions/)** - Monitor instructions that affect balances
- **[Solana DEX Trades API](https://docs.bitquery.io/docs/examples/Solana/solana-dextrades/)** - Track trading activities that impact balances
- **[Solana Fees API](https://docs.bitquery.io/docs/examples/Solana/solana_fees_api/)** - Analyze fees that reduce balances
- **[Solana Token Supply API](https://docs.bitquery.io/docs/examples/Solana/token-supply-cube/)** - Monitor supply changes affecting balances
...
For tracking the transfers that cause these balance changes, see our **[Solana Transfers API](https://docs.bitquery.io/docs/examples/Solana/solana-transfers/)**.
