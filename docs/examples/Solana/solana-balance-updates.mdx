...
[This query](https://ide.bitquery.io/top-100-holders-of-token-on-Solana) returns the top 100 token holders of a particular token after a
given time.
  ...
  Solana {
    BalanceUpdates(
      ...
      where: {BalanceUpdate: {Currency: {MintAddress: 
        {is: "Hrt2MqJjGYSG1eL1dfAuLWJFsPUnjzRKqesyma3Gpump"}},
