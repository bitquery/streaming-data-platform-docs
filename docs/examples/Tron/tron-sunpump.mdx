...
Try [this query](
https://ide.bitquery.io/SunPump-Bonding-Curve-TRX-Balance).
...
Historical TRX balance in bonding curve based on dex trades. Calculated as balance = in_sum - out_sum
