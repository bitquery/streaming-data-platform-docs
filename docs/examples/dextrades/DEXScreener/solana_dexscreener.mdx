...
Checkout our [DEXScreener EVM API documentation](https://docs.bitquery.io/docs/examples/dextrades/DEXScreener/evm_dexscreener/) if you are interested in getting EVM chains(Ethereum, Binance Smart Chain(BSC), Arbitrum, Base, Matic, Optimism, etc) data which DEXScreener shows.
...
- **[Solana API Examples](https://docs.bitquery.io/docs/examples/Solana/)** - Complete collection of Solana API examples
- **[Solana DEX Trades](https://docs.bitquery.io/docs/examples/Solana/dextrades)** - Real-time DEX trading data and analytics
