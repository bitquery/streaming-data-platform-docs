...
[Run Query](https://ide.bitquery.io/OHLC-of-a-pair-on-all-Uniswap-versions)
...
query tradingViewPairs($network: evm_network, $dataset: dataset_arg_enum, $interval: Int, $token: String, $base: String, $from: DateTime, $to: DateTime) {
  EVM(network: $network, dataset: $dataset) {
    DEXTradeByTokens(
      orderBy: {ascendingByField: "Block_Time"}
      where: {TransactionStatus: {Success: true}, Trade: {Side: {Amount: {gt: "0"}, Currency: {SmartContract: {is: $token}}}, Currency: {SmartContract: {is: $base}}, Success: true, Dex: {ProtocolName: {in: ["uniswap_v3", "uniswap_v2", "uniswap_v1"]}}}, Block: {Time: {since: $from, till: $to}}}
    ) {
      Block {
...
{
  "network": "eth",
  "base": "0x2653cd00ceb854efb65b1bb4cbf19c760f66cc3e",
  "token": "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2",
  "dataset": "realtime",
  "interval": 60,
  "from": "2025-07-26T06:41:38.000Z",
  "to": "2025-07-29T06:41:38.000Z"
}
