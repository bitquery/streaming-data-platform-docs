...
[Here](https://ide.bitquery.io/Get-Minted-Address-of-the-ICO-Token_2) is the query to find if the token in question also follows a similiar procedure, and if yes, then contract address of the distributer. 
