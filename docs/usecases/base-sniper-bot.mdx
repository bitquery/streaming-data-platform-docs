---
title: "Tutorial : Building a Base Sniper Bot Using Bitquery Base Events API and Uniswap SDK"
description: "Bitquery how-to guide: Tutorial : Building a Base Sniper Bot Using Bitquery Base Events API and Uniswap SDK."
---
