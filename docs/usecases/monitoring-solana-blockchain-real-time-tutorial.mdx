...
description: "Bitquery how-to guide: Monitoring the Solana Blockchain in Real Time - Easy Tutorial."
---
...
To generate a token to run the subscription, check [the guide here](https://docs.bitquery.io/docs/authorization/how-to-generate/).
