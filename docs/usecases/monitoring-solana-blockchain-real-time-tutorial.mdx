---
title: "Monitoring the Solana Blockchain in Real Time - Easy Tutorial"
description: "Monitoring blockchain activities is crucial for developers, investors, and regulatory bodies. Bitquery offers the infrastructure to monitor blockchain activities effectively. In this tutorial, we'll use Bitquery Solana real-time data and Python to build a real-time Solana DEX monitoring dashboard."
---
...
To generate a token to run the subscription, check [the guide here](/docs/authorization/how-to-generate/).
