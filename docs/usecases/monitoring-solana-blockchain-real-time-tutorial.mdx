...
description: "Build Monitoring the Solana Blockchain in Real Time: a practical Bitquery tutorial with GraphQL examples, streams, and runnable application code."
---
...
async def run_subscription():
    ...
    transport = WebsocketsTransport(
        url="wss://streaming.bitquery.io/graphql?token=<YOUR TOKEN HERE>",
