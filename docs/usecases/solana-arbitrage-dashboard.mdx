---
sidebar_position: 4
title: "Solana Arbitrage Dashboard Project"
description: "The following tutorial is a step by step guide to build a Dashboard that displays arbitrage opportunities for WSOL/USDC pair on Solana."
---
...
<video controls loop muted playsInline width="100%" src="/img/ApplicationExamples/arbsol.mp4"></video>
...
1.  Next: An optimized version of React for building user interfaces with server-side rendering.
