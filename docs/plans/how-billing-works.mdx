...
| Plan | Monthly | Annual (per mo) | Points / mo | Rate limit | Concurrent streams |
|---|---|---|---|---|---|
| Personal | $49/mo | $39/mo | 100K | 30 / min | — |
| Pro | $99/mo | $79/mo | 1M | 90 / min | 100 |
| Scale | $299/mo | $239/mo | 5M | 240 / min | 1,000 |
| Enterprise | Custom | Custom | Custom | Custom | Unlimited |

Annual billing saves 20% and locks the price for 12 months. **Self-service plans are real-time only** — no plan includes archive history. Archive access is bought per chain as an add-on; see [Upgrade to Paid Plan](/docs/ide/paid/#historical-data-add-ons).
