...
description: "Bitquery GraphQL dataset guide: Early Access Program."
---
...
APIs use OAuth token mechanism for authentication. Read more on how to generate a token [here](https://docs.bitquery.io/docs/authorization/how-to-generate/)
