---
title: "Tron SunPump API"
description: "Tron Sunpump: real-time Tron memecoin and DEX data via Bitquery GraphQL APIs and Kafka streams. Run it in the IDE, then ship in your app."
---
# Sun Pump API
...
For live DEX prices and volume across Tron memecoins (including Sun Pump tokens), see [DEXrabbit's Tron Meme Coins category](https://dexrabbit.bitquery.io/categories/tron-meme).
...
query SunPumpTokenPools {
  Tron(dataset: combined) {
    DexPools: Balances(
      where: {Balance: {Address: {is: "TTfvyrAz86hbZk5iDpKD78pqLGgi8C7AAw"}}}
...
To learn the difference between DEXTrades and DEXTradeByTokens API, read [this](/docs/cubes/dextrades/) and [this](/docs/cubes/dextradesbyTokens/) doc.
