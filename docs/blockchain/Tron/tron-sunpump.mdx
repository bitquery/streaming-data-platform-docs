...
<head>
  ...
  <meta name="description" content="Real-time Sun Pump on Tron—token launches, subscriptions, live trades—with Bitquery V2; scale via WebSockets or Kafka."/>
  <meta name="keywords" content="Real time Sun Pump, Stream Sun Pump Tron, Sun Pump subscription, Sun Pump websocket, Sun Pump launch stream, Sun Pump API,Sun Pump on-chain data API,Sun Pump token data API,Sun Pump blockchain API,Sun Pump DEX data API,Sun Pump API documentation,Sun Pump crypto API,Sun Pump web3 API,DEX Trades,Tron,Sun Pump memecoins,Tron DEX,token trading,blockchain data,crypto trading, Tron Kafka stream"/>
...
<meta
  ...
  content="Live Sun Pump Tron data—launch subs, streaming trades, Kafka-ready."
/>

  <meta property="twitter:card" content="summary_large_image"/>
  <meta property="twitter:title" content="How to Get Sun Pump On-Chain Data with Sun Pump API"/>
  <meta property="twitter:description" content="Real-time Sun Pump API—streaming launches and trades on Tron."/>
</head>
