...
- [Realtime Prices, OHLC, Trading Volume of all pairs ➤](#realtime-prices-ohlc-trading-volume-of-all-pairs)
...
## Realtime Prices, OHLC, Trading Volume of all pairs
...
[Realtime Prices, OHLC, Trading Volume of all pairs — Query ➤](https://ide.bitquery.io/aerodrome-dex---realtime-prices-1-sec-ohlc-trading-volumes)
...
### Video Tutorial | How to stream Realtime Prices, OHLCV, and Moving Averages for trading pairs on Aerodrome DEX

<VideoPlayer url="https://www.youtube.com/watch?v=hD9RQP3r3IM" />
