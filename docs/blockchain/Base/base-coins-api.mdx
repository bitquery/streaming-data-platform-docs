---
sidebar_position: 7
title: "Base Network Coins API"
description: "Base Network Coins API: query and stream Base on-chain data with Bitquery GraphQL examples for developers. Great for bots, dashboards, and alerts."
---
...
You can checkout more queries related to tokens and token trades [here](/docs/blockchain/Ethereum/dextrades/token-trades-apis/#ohlc-in-usd-of-a-token).
