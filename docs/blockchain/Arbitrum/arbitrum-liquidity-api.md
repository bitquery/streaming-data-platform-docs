...
<FAQ
  items={[
    ...
    { q: "Which DEXs does the Arbitrum liquidity cube cover?", a: "Rows come from Uniswap v2, v3 and v4 pools and PancakeSwap v3 pools. Balancer, Curve, Fluid and DODO have swaps in the DEX trades cube but no reserve rows here, and Camelot is not indexed." },
