...
description: Collection of Arbitrum APIs organized by topic including DEX trades, liquidity pools, slippage data, and more.
...
- [Arbitrum Address Balance API](./arbitrum-balance-api) — token and [native ETH](./arbitrum-balance-api#native-eth-balance) balances (`EVM.Balances`)

Access comprehensive blockchain data including blocks, transactions, contract interactions, and wallet balances.
