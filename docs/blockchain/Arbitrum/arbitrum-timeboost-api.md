---
sidebar_position: 11
title: "Arbitrum TimeBoost API & Streams"
description: "Arbitrum sequencers traditionally ordered transactions on a first-come-first-serve (FCFS) basis. TimeBoost introduced an auction-driven priority lane that lets searchers bid for earlier inclusion. With Bitquery’s Stream you can subscribe to every call that interacts with the TimeBoost auction…"
---
