...
Open it with this [link](https://ide.bitquery.io/latest-trades-for-a-token---both-buy-and-sell).
...
Open it with this [link](https://ide.bitquery.io/token-trades-for-a-specific-DEX_1).
...
Open it with this [link](https://ide.bitquery.io/latest-token-trades-subscription).
