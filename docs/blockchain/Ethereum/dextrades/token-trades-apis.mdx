...
Run this to get up to 100 tokens with aggregated USD volume and average price over the last 24 hours, including separate stats for 1h, 4h, and 24h windows (supports Ethereum and other chains):
