...
description: "Bitquery blockchain API docs: DEXScreener EVM API."
---
# DEXScreener EVM API
...
Checkout our [DEXScreener Solana API documentation](https://docs.bitquery.io/docs/blockchain/Ethereum/dextrades/DEXScreener/solana_dexscreener/) if you are interested in getting Solana data which DEXScreener shows.
