...
title: "Uniswap API"
description: "Access real-time on-chain data for Uniswap tokens using the Bitquery-powered Uniswap API. Track trades, liquidity, token prices, and more on Ethereum"
---
...
We launched the [Price Index](/docs/category/price-index/) in August 2025, allowing you to track price for any onchain token pair.
