...
The new [Price Index Stream](/docs/trading/crypto-price-api/introduction/) helps you get token-level, pair-level, and market-level OHLC data for 1 sec interval( or higher), in real-time across all chains.
