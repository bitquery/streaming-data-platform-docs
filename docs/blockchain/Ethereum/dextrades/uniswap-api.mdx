...
title: "Uniswap API"
description: "Bitquery blockchain API docs: Uniswap API."
---
...
To get details on Uniswap v3 Positions, check the examples available in [this page](https://docs.bitquery.io/docs/blockchain/Ethereum/dextrades/uniswap-position-api/)
