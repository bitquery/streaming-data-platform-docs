---
sidebar_position: 1
title: "Analyzing Token ICO with Transfers APIs"
description: "In this segment we will learn how you can analyze a project's ICO performance, to help investors in taking smart investment decisions based on that knowledge. For this tutorial, we will look up the info related to PEPU token."
---
import VideoPlayer from "../../../../src/components/videoplayer.js";

# Analyzing Token ICO with Transfers APIs

In this segment we will learn how you can analyze a project's ICO performance, to help investors in taking smart investment decisions based on that knowledge. For this tutorial, we will look up the info related to [PEPU](https://explorer.bitquery.io/ethereum/token/0x906cc2ad139eb6637e28605f908903c8adce566a) token
...
## Video Tutorial on How to Analyze ICO of PEPU Token
