---
sidebar_position: 2
title: "Get Supply and Marketcap of a Token"
description: "Get Supply and Marketcap of a Token: monitor Ethereum native and token transfers in real time with Bitquery GraphQL APIs."
---
# Get Supply and Marketcap of a Token

We will use the [Transaction Balance Tracker APIs](/docs/blockchain/Ethereum/balances/transaction-balance-tracker/) for this query.
