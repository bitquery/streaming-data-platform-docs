...
Now, you may note that unlike the JSON RPC method, this API does'nt return any `log` object. However, if that is something you might need then checkout the following page for [eth_getLogs](/docs/blockchain/Ethereum/ethers-library/eth_getLogs/). 
