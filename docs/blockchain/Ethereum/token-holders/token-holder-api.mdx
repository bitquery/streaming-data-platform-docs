...
<FAQ
  items={[
    { q: "Which endpoint should I use for ERC-20 holders?", a: "Use EVM.Holders. The older EVM.TokenHolders field is deprecated and will be removed — migrate to Holders with Amount(selectWhere: { gt: \"0\" })." },
