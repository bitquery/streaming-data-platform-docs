...
**Use the [Bitquery MCP Server](/docs/usecases/MCP/)** for the hosted ClickHouse-backed MCP, or follow this [walkthrough on building MCPs with Bitquery](https://youtu.be/q-QL5EGfT5k).
