...
description: "Bitquery blockchain API docs: Raydium DEX API - Solana Trades, Pools, OHLC."
---
...
<head>
<meta name="title" content="Raydium DEX API - Solana Trades, Pools, OHLC"/>
<meta name="description" content="Real-time Raydium DEX data on Solana: liquidity pools, trades, OHLC. GraphQL API for Raydium AMM and CLMM."/>
...
<meta
  property="og:title"
  content="Raydium DEX API - Solana Trades, Pools, OHLC"
/>
<meta
  property="og:description"
  content="Real-time Raydium DEX data on Solana: liquidity pools, trades, OHLC. GraphQL API for Raydium AMM and CLMM."
/>

<!-- Twitter -->

<meta property="twitter:card" content="summary_large_image" />
<meta property="twitter:title" content="Raydium DEX API - Solana Trades, Pools, OHLC" />
<meta property="twitter:description" content="Real-time Raydium DEX data on Solana: liquidity pools, trades, OHLC. GraphQL API for Raydium AMM and CLMM." />
</head>
...
<FAQ
  items={[
    { q: "How do I stream Raydium trades in real time?", a: "Use a GraphQL subscription on Solana.DEXTrades with ProtocolName raydium, or connect to solana.dextrades.proto on Kafka for high throughput." },
    { q: "How do I get OHLC for a Raydium pair?", a: "Aggregate DEXTradeByTokens by interval for the pool or token mint. For recent data with USD on every row, try Trading.Trades filtered to Raydium on Solana." },
    { q: "Can I track new Raydium pool creation?", a: "Yes. Query or subscribe to DEXPools filtered by Raydium protocol and sort by creation time. Pool-creation examples are on this page." },
  ]}
/>
