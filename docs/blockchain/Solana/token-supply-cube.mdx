...
description: "Bitquery blockchain API docs: Solana Token Supply API."
---
...
- **[Solana Balance Updates API](https://docs.bitquery.io/docs/blockchain/Solana/solana-balance-updates/)** - Monitor balance changes from supply updates
- **[Solana Transfers API](https://docs.bitquery.io/docs/blockchain/Solana/solana-transfers/)** - Track transfers that affect token supply
- **[Solana DEX Trades API](https://docs.bitquery.io/docs/blockchain/Solana/solana-dextrades/)** - Monitor trading activities impacting supply
- **[Solana Fees API](https://docs.bitquery.io/docs/blockchain/Solana/solana_fees_api/)** - Analyze fees from supply-related transactions
...
For tracking the instructions that cause these supply changes (like token creation and burning), see our **[Solana Instructions API](https://docs.bitquery.io/docs/blockchain/Solana/solana-instructions/)**.
