...
> **Before you start**: Not sure when to use DEX Trades vs Transfers vs other data primitives? Read our [Mental Model guide](https://docs.bitquery.io/docs/start/mental-model-transfers-events-calls) to understand which primitive to use for your use case.
...
For analyzing the transaction fees associated with these trades, see our **[Solana Fees API](https://docs.bitquery.io/docs/blockchain/Solana/solana_fees_api/)**.
