...
```graphql

 {
  Trading {
    Pairs(
      where: {Price: {IsQuotedInUsd: false}, Market: {Network: {is: "Solana"}, Program: {is: "6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P"}}, Token: {Address: {is: "5cd1amZcopDYP3jBHZMfDCH5epWCGfsJvEXFJkgepump"}}, Interval: {Time: {Duration: {eq: 60}}}}
      limit: {count: 1}
