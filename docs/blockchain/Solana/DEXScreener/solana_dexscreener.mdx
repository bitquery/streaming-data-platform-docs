...
description: "What the public DEX Screener API covers (300 requests a minute, current pair data, no candles, history or trade stream) and how to get the same Solana pair data with history, OHLC, WebSocket and Kafka streams from Bitquery."
keywords:
  - DEXScreener API
...
| Token profiles, boosts, community takeovers, ads, metas (REST and WebSocket) | 60 requests a minute | Listing and promotion metadata |
...
- **Cloud delivery** to AWS, GCP and Snowflake for analytics workloads.
