...
<head>
  <meta
    name="title"
    content="DEXScreener API Documentation - Solana Trades, Pairs, Prices"
  />
  <meta
    name="description"
    content="DEXScreener API documentation for Solana: get real-time trades, pair data, prices, volumes. Same data as DEXScreener dashboard via GraphQL, WebSocket, and Kafka."
  />
  <meta
    name="keywords"
    content="DEXScreener API, DEXScreener API documentation, DEXScreener Solana, Solana DEX API, real-time DEX trades"
  />
