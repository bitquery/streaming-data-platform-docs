---
title: "Historical Solana Data API"
description: "Historical Solana Data API: query and stream Solana on-chain data with Bitquery GraphQL examples for developers. Built for traders and analytics teams."
