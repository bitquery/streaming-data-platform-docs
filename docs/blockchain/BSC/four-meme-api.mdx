...
[Run Query](https://ide.bitquery.io/first-transfers-of-a-token_2)
  ...
  EVM(network: bsc, dataset: combined) {
    Transfers(
      ...
      where: {
        TransactionStatus: { Success: true }
        Transfer: {
          Receiver: { not: "0x5c952063c7fc8610ffdb798152d69f0b9550762b" }
          Currency: {
            SmartContract: { is: "0x35a7bb282d8caafe71617c9d52ee30f1adfe4444" }
          }
        }
      }
    ) {
...
[Run Query](https://ide.bitquery.io/get-first-buys-of-an-address-list-of-a-specific-token)
