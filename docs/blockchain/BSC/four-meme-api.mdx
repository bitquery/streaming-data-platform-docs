...
Need low-latency BSC data? See [Streams](https://docs.bitquery.io/docs/streams/) and contact us for a trial. For **mempool (pre-confirmation)** Four Meme data, see the dedicated [Four Meme Mempool API](./four-meme-mempool-API) page.
...
| Can I monitor Four Meme transactions in the BSC mempool before confirmation? | **Separate guide:** [Four Meme Mempool API](./four-meme-mempool-API) (not duplicated on this page) |
