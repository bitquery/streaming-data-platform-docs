...
<head>
<meta name="title" content="BSC DEX Pool Slippage Data with BSC Slippage API"/>
<meta name="description" content="Get slippage and price impact data for BSC DEX pools through our Slippage API."/>
<meta name="keywords" content="BSC slippage api, BSC DEX pool api, BSC liquidity api, BSC price impact api, BSC DEX api, BSC web3 api"/>
...
<meta
  property="og:title"
  content="How to Get BSC DEX Pool Slippage Data with BSC Slippage API"
/>
<meta
  property="og:description"
  content="Get slippage and price impact data for BSC DEX pools through our Slippage API."
/>

<!-- Twitter -->

<meta property="twitter:card" content="summary_large_image" />
<meta property="twitter:title" content="How to Get BSC DEX Pool Slippage Data with BSC Slippage API" />
<meta property="twitter:description" content="Get slippage and price impact data for BSC DEX pools through our Slippage API." />
</head>
...
You can find the query [here](https://ide.bitquery.io/realtime-slippage-on-bsc)
...
Slippage data can also be obtained via Kafka streams for lower latency and better reliability. The Kafka topic for BSC DEX pools is:
