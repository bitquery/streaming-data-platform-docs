...
description: "Bitquery blockchain API docs: BSC Liquidity API."
---
# BSC Liquidity API

In this section we will see how to get BSC DEX pool liquidity information using Bitquery API. The liquidity API helps you monitor real-time liquidity changes, track pool reserves, and analyze liquidity depth for token pairs on BSC DEX pools.

<head>
<meta name="title" content="BSC DEX Pool Liquidity Data with BSC Liquidity API"/>
<meta name="description" content="Get real-time liquidity and pool reserve data for BSC DEX pools through our Liquidity API."/>
<meta name="keywords" content="BSC liquidity api, BSC DEX pool api, BSC pool reserves api, BSC liquidity monitoring api, BSC DEX api, BSC web3 api, Binance Smart Chain liquidity api"/>
...
<meta
  property="og:title"
  content="How to Get BSC DEX Pool Liquidity Data with BSC Liquidity API"
/>
<meta
  property="og:description"
  content="Get real-time liquidity and pool reserve data for BSC DEX pools through our Liquidity API."
/>

<!-- Twitter -->

<meta property="twitter:card" content="summary_large_image" />
<meta property="twitter:title" content="How to Get BSC DEX Pool Liquidity Data with BSC Liquidity API" />
<meta property="twitter:description" content="Get real-time liquidity and pool reserve data for BSC DEX pools through our Liquidity API." />
</head>
...
You can find the query [here](https://ide.bitquery.io/Realtime-Liquidity-Stream_2#)
...
You can find the query [here](https://ide.bitquery.io/Latest-Liquidity-Changes-of-a-Specific-Pool_2#)
  ...
  EVM(network: bsc) {
    DEXPoolEvents(
      ...
      where: {
        PoolEvent: {
          Pool: {
            SmartContract: { is: "0xdf5106e47956dbc54524a941dc858cf9d4e91972" }
          }
        }
      }
    ) {
...
You can find the query [here](https://ide.bitquery.io/Realtime-Liquidity-Stream-of-a-Specific-Pool_1)
...
You can find the query [here](https://ide.bitquery.io/Latest-Liquidity-Changes-of-Pools-in-a-Specific-DEX-Protocol---Uniswap-V4)
...
Liquidity data can also be obtained via Kafka streams for lower latency and better reliability. The Kafka topic for BSC DEX pools is:
