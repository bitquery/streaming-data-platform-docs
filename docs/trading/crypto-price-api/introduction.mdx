...
description: "Crypto Price API – Real-Time Token Data, Charts & OHLC via Bitquery Trading APIs for multi-chain prices, OHLC candles, volume metrics, and live streams."
keywords:
  - "crypto price API"
