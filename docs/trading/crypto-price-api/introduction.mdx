---
title: "Crypto Price API - Real-time Multi-chain Price Data & OHLC"
description: "Access real-time, aggregated cryptocurrency price data across EVM, Solana, Tron, and other chains. Get OHLC, moving averages, and volume data with ultra-low latency for trading bots, DeFi protocols, and charting applications."
keywords: "crypto price API, cryptocurrency price data, real-time price feed, OHLC data, multi-chain price API, blockchain price data, trading API, DeFi price feed, crypto market data, price index, moving averages, volume data, trading bots, charting API, EVM price data, Solana price API, Tron price data, cross-chain prices, aggregated price data, low latency price feed"
---
